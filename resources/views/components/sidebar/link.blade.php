...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-gray-500 shadow-lg hover:bg-gray-600' : 'text-white hover:text-gray-700 hover:bg-gray-200 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
